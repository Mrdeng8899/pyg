            ...
            <div class="yui3-g home">
                ...
                <div class="yui3-u-1-6 list">
                    ...
                    <div class="list-items">
                        <dl>
							<dt><i>·</i> 订单中心</dt>
							<dd ><a href="<?php echo url('home/order/myorder'); ?>"   class="list-active">我的订单</a></dd>
                            <dd><a href="<?php echo url('home/order/details'); ?>" >待付款</a></dd>
						...
						<dl>
							<dt><i>·</i> 我的中心</dt>
							<dd><a href="<?php echo url('home/collect/show'); ?>">我的收藏</a></dd>
						...
						<dl>
                            ...
                            <dd><a href="<?php echo url('home/user/safa'); ?>" >安全管理</a></dd>
						</dl>
                    </div>
                </div>
                <!--右侧主内容-->
                <div class="yui3-u-5-6">
                    <div class="body">
                            ...
                            <div class="order-bar">
                                <div class="sui-steps-round steps-round-auto steps-4">
                                    <div class="finished">
                                        ...
                                        <label>
                                            <span>提交订单</span>
                                            <span><?php echo $res['create_time']; ?></span>
                                            <span><?php echo $res['update_time']; ?></span>
                                        </label>
                                    </div>
                                    <div class="current">
                                        <div class="wrap">
                        ...
                        <div class="order-info">
                            <h5>订单信息</h5>
                            <p>收货地址：<?php echo $res['address']; ?>  </p>
                            <p>订单单号：<?php echo $res['order_sn']; ?></p>
                            <p>下单时间：<?php echo $res['create_time']; ?></p>
                            <p>支付时间：<?php echo $res['create_time']; ?></p>
                            <p>支付方式：<?php echo $res['pay_code']; ?></p>
                            <p>发货时间：<?php echo $res['create_time']; ?></p>
                        </div>
                        <div class="order-goods">
                            <table class="sui-table">
                                ...
                                <tbody>                               
                                    ...
                                    <tr>
                                        <td>
                                            <div class="typographic"><img src="<?php echo $res['order_goods']['goods_logo']; ?>" />
                                                    <span>包邮 <?php echo $res['order_goods']['goods_name']; ?> 新款</span>
                                                    <span class="guige">规格：<?php echo $res['order_goods']['spec_value_names']; ?></span>
                                                </div>
                                        </td>
                                        <td>
                                            <ul class="unstyled">
                                                    <li class="o-price">¥<?php echo $res['goods_price']; ?></li>
                                                    <li>¥<?php echo $res['goods_price']; ?></li>
                                                </ul>
                                        </td>
                                        <td>1</td>
                                        <td>无优惠</td>
                            ...
                            <div class="order-price">
                                <p>商品总金额：￥<?php echo $res['goods_price']; ?></p>
                                <p>运费金额：，免费用</p>
                                <p>使用优惠券：无</p>
                                <h4 class="red">实际支付：￥<?php echo $res['goods_price']; ?></h4>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        <!--猜你喜欢-->
