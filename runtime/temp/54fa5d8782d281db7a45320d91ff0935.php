            ...
            <div class="goods">
                <div class="left-good">
                    ...
                    <div class="right-info">
                        ...
                        <p class="attr"><?php echo $goods['value_names']; ?>数量：<?php echo \think\Request::instance()->param('number'); ?></p>
                    </div>
                </div>
                <div class="right-gocart">
                    <a href="#" class="sui-btn btn-xlarge">查看商品详情</a>
                    <a href="<?php echo url('home/cart/index'); ?>" class="sui-btn btn-xlarge btn-danger " target="_blank">去购物车结算 > </a>
                </div>
            </div>
            </div>
    </div>
