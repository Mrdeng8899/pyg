                    ...
                    <div class="body userInfo">
                        ...
                        <div class="tab-content ">
                            <div id="one" class="tab-pane active">
                                ...
                                <form id="form-msg" class="sui-form form-horizontal" action="<?php echo url('home/user/edit'); ?>" enctype="multipart/form-data">
                                    <div class="control-group">
                                        <label for="inputName" class="control-label">昵称：</label>
                                        <div class="controls">
                                            <input type="text" id="inputName" name="nickname" placeholder="昵称" value="<?php echo $info['nickname']; ?>">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label for="inputGender" class="control-label">性别：</label>
                                        <div class="controls">
                                            <label data-toggle="radio" class="radio-pretty <?php if(($info['sex']=='男')): ?>checked<?php endif; ?> inline">
                                            <input type="radio" name="sex" value="1" <?php if(($info['sex']=='男')): ?>checked<?php endif; ?>><span>男</span>
                                        </label>
                                            <label data-toggle="radio" class="radio-pretty <?php if(($info['sex']=='女')): ?>checked<?php endif; ?>  inline">
                                            <input type="radio" name="sex" value="2" <?php if(($info['sex']=='女')): ?>checked<?php endif; ?>><span>女</span>
                                        </label>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select id="select_year2" name="old" rel="<?php echo $info['old']; ?>"></select>年
                                            <select id="select_month2" name="month" rel="<?php echo $info['month']; ?>"></select>月
                                            <select id="select_day2" name="day" rel="<?php echo $info['day']; ?>"></select>日
                                        </div>
                                    </div>
                                        ...
                                        <div class="controls">
                                            <div id="citry">
                                                <div class="form-group area">
                                                    <select class="form-control" id="province1" name="site">
                                                    </select>
                                                </div>
                                                <div class="form-group area">
                                                    <select class="form-control" id="city1" name="citry"></select>
                                                </div>
                                                <div class="form-group area">
                                                    <select class="form-control" name="country" id="district1"></select>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label for="inputName" class="control-label">职业：</label>
                                        <div class="controls">
                                            <input type="text" id="inputNames" name="career"value="<?php echo $info['career']; ?>">
                                        </div>
                                    </div>
                                    <div class="control-group">
                            ...
                            <div id="two" class="tab-pane">
                                <div class="new-photo">
                                    <p>当前头像：</p>
                                    <div class="upload">
                                        <form action="<?php echo url('home/user/file'); ?>" method="post" enctype="multipart/form-data">
                                        <img id="imgShow_WU_FILE_0" width="100" height="100" src="<?php echo $info['user_header']; ?>" alt="">
                                        <input type="file" id="up_img_WU_FILE_0" name="user_header"/>
                                            <div class="controls">
                                                <button type="submit" class="sui-btn btn-primary" style="margin-top: 10px;">立即上传</button>
                                            </div>
                                        </form>
                                    </div>
...
<script>
            $(function() {               
                ...
                $('#citry').distpicker('destroy').distpicker({
                    province:'<?php echo $info['site']; ?>',
                    city:'<?php echo $info['citry']; ?>',
                    district:"<?php echo $info['county']; ?>",
                })
            });
        </script>
