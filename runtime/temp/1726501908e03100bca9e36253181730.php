...
<div id="nav-bottom">
				...
				<div class="step-cont">
					<div class="addressInfo">
						<ul class="addr-detail">
							...
							<li class="addr-item">
								<div address_id="<?php echo $v['id']; ?>" class="con name <?php if(($v['is_default']==1)): ?>selected<?php endif; ?>"><a href="javascript:;" ><em><?php echo $v['consignee']; ?></em><span title="点击取消选择">&nbsp;</span></a></div>
	...
	<script type="text/javascript">
		$(function(){
			//页面加载完成，将选中的地址，放到页面下方展示//element参数，需要是一个jq对象
			...
			$('.submit').click(function () {
				// 获取选中的地址的id
				var address_id=$('.addressInfo').find('.selected').attr('address_id');
				// 将 地址id 放到表单中
