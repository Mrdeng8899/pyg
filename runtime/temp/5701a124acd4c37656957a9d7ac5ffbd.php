<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"C:\newww\tpshop\public/../application/home\view\goods\detail.html";i:1576162809;s:49:"C:\newww\tpshop\application\home\view\layout.html";i:1576482718;}*/ ?>
<!DOCTYPE html>
<html>
...
<div id="nav-bottom">
					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl>
								...
								<?php foreach($spec['spec_values'] as $k=>$value): ?>
								<dd><a href="javascript:;" value_id="<?php echo $value['id']; ?>" class="<?php if(($k == 0)): ?>selected<?php endif; ?>"><?php echo $value['spec_value']; ?><span title="点击取消选择">&nbsp;</span></a></dd>
								<?php endforeach; ?>
							</dl>
							<?php endforeach; ?>
						</div>
	...
	<script type="text/javascript">
		var values_msp=<?php echo $values_msp; ?>;
		...
		$(function(){
			...
			$('#specification').find('a').click(function(){
				...
				//获取所有选中的规格值 id  拼接成 28_32这种形式
				var value_ids = '';
				$('.selected').each(function(i,v){
					value_ids += $(v).attr('value_id') + '_';
				});
				//去除最后多余的_
				value_ids = value_ids.slice(0, -1); // 28_32
				//获取对应的价格
				var price = values_msp[value_ids] ? values_msp[value_ids].price : 0;
				if(price){
					//将价格显示到页面
			...
			$('#addshopcar').click(function () {
				...
				// 取出最后一个的下划线
				value_ids=value_ids.slice(0,5);
				// 获取sku的id
				var spec_goods_id='';
				if(values_msp[value_ids]){
					spec_goods_id=values_msp[value_ids].id;
				}
				// 将sku的id 放到隐藏域中
        ...
        <div class="footlink">
            ...
            <div class="Mod-copyright">
                <ul class="helpLink">
                    ...
                    <li>关于我们<span class="space"></span></li>
                    <li><a href="<?php echo url('home/index/shopinto'); ?>">商家入驻</a><span class="space"></span></li>
