<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"C:\newww\tpshop\public/../application/home\view\cart\index.html";i:1576398358;s:49:"C:\newww\tpshop\application\home\view\layout.html";i:1576482718;}*/ ?>
<!DOCTYPE html>
<html>
						...
						<div class="cart-list">
							<ul class="goods-list yui3-g" cart_id="<?php echo $v['id']; ?>" number="<?php echo $v['number']; ?>">
								<li class="yui3-u-1-24">
									<input type="checkbox" class="row_check" name="" <?php if(($v['is_selected'])): ?>checked="checked"<?php endif; ?>>
								</li>
