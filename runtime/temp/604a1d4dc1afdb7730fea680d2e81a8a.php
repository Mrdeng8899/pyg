<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"C:\newww\tpshop\public/../application/home\view\user\usersafa.html";i:1576399888;s:49:"C:\newww\tpshop\application\home\view\layout.html";i:1576306169;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="yui3-g home">
                ...
                <div class="yui3-u-1-6 list">
                    ...
                    <div class="person-info">
                        <div class="person-photo"><img ssrc="<?php echo $safa['user_header']; ?>" style="width: 34px;height: 34px; border-radius: 50%
" alt=""></div>
                        <div class="person-account">
                            <span class="name"><?php echo $safa['nickname']; ?></span>
                    ...
                    <div class="list-items">
						...
						<dl>
							...
							<dd><a href="<?php echo url('home/collect/track'); ?>">我的足迹</a></dd>
						</dl>
						<dl>
							<dt><i>·</i> 物流消息</dt>
						</dl>
                    ...
                    <div class="body userSafe">
                        ...
                        <div class="tab-content ">
                            <div id="one" class="tab-pane active">
                                <form class="sui-form form-horizontal sui-validate" id="jsForm" action="<?php echo url('home/user/password'); ?>" enctype="multipart/form-data">
                                    <div class="control-group">
                                        <label for="inputusername" class="control-label">用户名：</label>
                                        <div class="controls">
                                            <input id="pwdid" class="fn-tinput" value="<?php echo $safa['nickname']; ?>" name="nickname" placeholder="输入昵称"
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input class="fn-tinput" type="password"  name="password" value="" placeholder="旧密码" required id="password">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label for="inputRepassword" class="control-label">新密码：</label>
                                        <div class="controls">
                                            <input class="fn-tinput" type="password" name="confirm_password" value="" placeholder="新密码">
                                        </div>
                                    </div>
                            ...
                            <div id="two" class="tab-pane">
                                ...
                                <form class="sui-form form-horizontal sui-validate" enctype="multipart/form-data" action="<?php echo url('home/user/call'); ?>">

                                    <div class="control-group">
                                        <label for="inputPassword" class="control-label">验证方式：</label>
                                        <div class="controls fixed">手机验证（<?php echo \think\Session::get('login_info.phone'); ?>）</div>
                                    </div>

                                    <div class="control-group">
                                        <label for="inputRepassword" class="control-label">手机号码：</label>
                                        <div class="controls">
                                            <input name="phone" type="text" id="msgcode" value="">
                                        </div>
                                        <div class="controls">
                                            <button type="button" id="phone">发送</button>
                                        </div>
                                    </div>


                                     <div class="control-group">
                                        <label for="inputcode" class="control-label">手机验证码：</label>
                                        <div class="controls">
                                            <input name="code" type="text" id="inputcode" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input name="newphone" type="text" id="call" value="">
                                        </div>
                                        <div class="controls">
                                            <button type="button" id="newphone">发送</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        <label for="inputcode" class="control-label">新手机验证码：</label>
                                        <div class="controls">
                                            <input name="codes" type="text" id="inputcode" >
                                        </div>
                                    </div>

                                    <div class="control-group next-btn">
<!--                                        <a class="sui-btn btn-primary" href="">确定更改</a>-->
                                        <button type="submit">确定更改</button>
                                    </div>
                                </form>
                            </div>
                        </div>
...
<script type="text/javascript" src="/static/home/js/jquery.validate/jquery.validate.js"></script>
<script>
        $(function () {
            $('#phone').click(function () {
                $.ajax({
                    'url':'<?php echo url("home/user/phone"); ?>',
                    'type':'get',
                    'data':'phone='+$('#msgcode').val(),
                    'dataType':'json',
            ...
            $('#newphone').click(function(){
                $.ajax({
                    'url':'<?php echo url("home/user/newphone"); ?>',
                    'type':'get',
                    'data':'phone='+$('#call').val(),
                    'dataType':'json',
                    'success':function (res) {
