<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"C:\newww\tpshop\public/../application/home\view\order\seckillOrder.html";i:1576326094;s:49:"C:\newww\tpshop\application\home\view\layout.html";i:1576306169;}*/ ?>
<!DOCTYPE html>
<html>
                            ...
                            <div class="orders">
                                ...
                                <div class="choose-title">
                                    <label data-toggle="checkbox" class="checkbox-pretty ">
                                           <input type="checkbox" checked="checked"><span><?php echo $v['order_goods']['create_time']; ?>　订单编号：<?php echo $v['order_sn']; ?>  店铺：哇哈哈 <a>和我联系</a></span>
                                     </label>
                                ...
                                <table class="sui-table table-bordered order-datatable">
                                    <tbody>
                                        <tr>
                                            <td width="35%">
                                                <div class="typographic"><img src="<?php echo $v['order_goods']['goods_logo']; ?>" />
                                                    <a href="<?php echo url('home/order/details',['id'=>$v['id']]); ?>" class="block-text">包邮 <?php echo $v['order_goods']['goods_name']; ?> 新款</a>
                                                    <span class="guige">规格：<?php echo $v['order_goods']['spec_value_names']; ?></span>
                                                </div>
                                            </td>
                                            ...
                                            <td width="10%" class="center">
                                                <ul class="unstyled">
													<li><a href="<?php echo url('home/cart/index'); ?>" class="sui-btn btn-info">立即付款</a></li>
                                                    <li>取消订单</li>
