<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"C:\newww\tpshop\public/../application/home\view\login\login.html";i:1576483464;}*/ ?>
<!DOCTYPE html>
<html>
	...
	<div class="login-box">
		...
		<div class="loginArea">
				...
				<div class="loginform">
					...
					<div class="tab-content tab-wraped">
						...
						<div id="profile" class="tab-pane  active">
							<form class="sui-form" action="<?php echo url('home/login/dologin'); ?>" method="post" enctype="multipart/form-data">
          ...
          自动登录
								...
								<div class="logined">
									<a class="sui-btn btn-block btn-xlarge btn-danger" href="javascript:void(0);" id="logins">登&nbsp;&nbsp;录</a>
								</div>
							</form>
							<div class="otherlogin">
								...
								<span class="register"><a href="<?php echo url('home/login/register'); ?>" target="_blank">立即注册</a></span>
								<span><a href="<?php echo url('home/login/emailzc'); ?>" target="_blank" style="margin-top: -48px; font-size: 15px; margin-left: 202px; float: left">邮箱注册</a></span>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="py-container copyright">
			<ul>
				...
				<li>联系我们</li>
				<li>联系客服</li>
				<li><a href="<?php echo url('home/index/shopinto'); ?>">商家入驻</a></li>
				<li>营销中心</li>
				<li>手机品优购</li>
				<li>销售联盟</li>
				<li>品优购社区</li>
