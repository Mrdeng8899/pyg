            ...
            <div class="yui3-g collect">
                ...
                <div class="yui3-u-1-6 list">
                    ...
                    <div class="list-items">
						...
						<dl>
							<dt><i>·</i> 我的中心</dt>
							<dd><a href="<?php echo url('home/collect/show'); ?>"  class="list-active">我的收藏</a></dd>
                    ...
                    <div class="body">                   
                            ...
                            <div class="goods-list">
                                <ul class="yui3-g"  id="goods-list">
                                    ...
                                    <li class="yui3-u-1-4">
                                        <div class="list-wrap">
                                            <a href="<?php echo url('home/goods/detail',['id'=>$v['id']]); ?>"><div class="p-img"><img src="<?php echo $v['goods_logo']; ?>" alt=''></div></a>
